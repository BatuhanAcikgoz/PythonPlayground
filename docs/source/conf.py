...
# OpenGraph ayarları
ogp_site_url = "https://batuhanacikgoz.github.io/ProgrammingPlayground/"
ogp_description_length = 300
ogp_type = "website"
ogp_site_name = "ProgrammingPlayground"

templates_path = ['_templates']
exclude_patterns = []
language = 'tr'

html_title = "ProgrammingPlayground"
html_theme = 'furo'
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/batuhanacikgoz/ProgrammingPlayground",
            "html": """
