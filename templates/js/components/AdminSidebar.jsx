...
const AdminSidebar = () => {
  ...
  return (
    <div className="w-64 min-h-screen shadow-lg bg-gradient-to-r from-gray-800 to-gray-800 text-white">
      <nav className="mt-4">
        <ul>
          ...
          <li className="mb-1">
            <a
              ...
              className="flex items-center py-2 px-4 text-white hover:bg-gray-200 dark:hover:bg-gray-700 hover:hover:text-white"
            >
          ...
          <li className="mb-1">
            ...
            <div className="flex items-center py-2 px-4 text-white">
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="pl-10">
              <li>
                <a href={urls.manageUsers} className="block py-2 px-4 text-white hover:bg-gray-100 dark:hover:bg-gray-700 hover:hover:text-white">
          ...
          <li className="mb-1">
            ...
            <ul className="pl-10">
              <li>
                <a href={urls.programmingQuestions} className="block py-2 px-4 text-white hover:bg-gray-100 dark:hover:bg-gray-700 hover:hover:text-white">
                  {sidebar_translations.manage_questions}
                </a>
              </li>
              <li>
                <a href={urls.newProgrammingQuestion} className="block py-2 px-4 text-white hover:bg-gray-100 dark:hover:bg-gray-700 hover:hover:text-white">
                  {sidebar_translations.add_question}
                </a>
              </li>
              <li>
                <a href={urls.newProgrammingQuestionAi} className="block py-2 px-4 text-white hover:bg-gray-100 dark:hover:bg-gray-700 hover:hover:text-white">
                  {sidebar_translations.add_question_ai}
                </a>
              </li>
              <li>
                <a href={urls.viewSubmissions} className="block py-2 px-4 text-white hover:bg-gray-100 dark:hover:bg-gray-700 hover:hover:text-white">
                  {sidebar_translations.view_submissions}
                </a>
              </li>
              <li>
                <a href={urls.testQuestion} className="block py-2 px-4 text-white hover:bg-gray-100 dark:hover:bg-gray-700 hover:hover:text-white">
          ...
          <li className="mb-1">
            ...
            <ul className="pl-10">
              <li>
                <a href={urls.badges} className="block py-2 px-4 text-white hover:bg-gray-100 dark:hover:bg-gray-700 hover:hover:text-white">
                  {sidebar_translations.manage_badges}
                </a>
              </li>
              <li>
                <a href={urls.newBadge} className="block py-2 px-4 text-white hover:bg-gray-100 dark:hover:bg-gray-700 hover:hover:text-white">
          ...
          {/* Settings */}
          <li className="mb-1">
            <a href={urls.settings} className="flex items-center py-2 px-4 text-white hover:bg-gray-100 dark:hover:bg-gray-700 hover:hover:text-white">
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
