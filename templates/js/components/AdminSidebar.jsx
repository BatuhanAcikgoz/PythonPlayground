const AdminSidebar = () => {
  ...
  return (
    <div className="w-64 min-h-screen shadow-lg bg-white text-gray-900 dark:bg-gray-900 dark:text-white">
      ...
      <nav className="mt-4">
        <ul>
          ...
          <li className="mb-1">
            <a
              href={urls.dashboard}
              className="flex items-center py-2 px-4 text-gray-800 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-black dark:hover:text-white"
            >
          ...
          <li className="mb-1">
            ...
            <ul className="pl-10">
              <li>
                <a className="block py-2 px-4 text-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white dark:text-gray-400">
          ...
          <li className="mb-1">
            ...
            <ul className="pl-10">
              ...
              <li>
                <a href={urls.viewSubmissions} className="block py-2 px-4 text-gray-400 hover:bg-gray-700 hover:text-white">
                  {translations.view_submissions}
                </a>
              </li>
              <li>
                <a href={urls.testQuestion} className="block py-2 px-4 hover:bg-gray-700 hover:text-white">
          ...
          {/* Badges Section */}
          <li className="mb-1">
<div className="flex items-center py-2 px-4 text-gray-700 dark:text-gray-300">
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Settings */}
          <li className="mb-1">
            <a href={urls.settings} className="flex items-center py-2 px-4 text-gray-400 hover:bg-gray-700 hover:text-white">
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
