...
class Config:
    ...
    WEB_PORT = os.environ.get('WEB_PORT') or '5000'
    SECRET_KEY = os.environ.get('SECRET_KEY') or 'dev-key'
    SQLALCHEMY_DATABASE_URI = os.environ.get('SQLALCHEMY_DATABASE_URI') or 'mysql+pymysql://pythonplayground:pythonplayground@10.0.50.20/python_platform'
